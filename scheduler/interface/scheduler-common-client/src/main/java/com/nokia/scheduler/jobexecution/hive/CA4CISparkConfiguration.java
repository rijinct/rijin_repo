...
public class CA4CISparkConfiguration implements HiveConfiguration {
	
	private static final String HIVE_CONFIG_FILE = "spark_config.properties";
	...
	public CA4CISparkConfiguration() throws IOException {
		this.hiveProperties = new Properties();
		InputStream inputStream = Files.newInputStream(FileUtils
				.getFile(getschedulerConfDirectory() + HIVE_CONFIG_FILE).toPath());
