...
@WebMvcTest(value = CronJobManagementController.class, secure = false)
@PrepareForTest({ ContextProvider.class })
public class CronJobManagementControllerTest {
	...
	private static final String URL_API_MANAGER_V1_scheduler_JOBS_CRON = "/api/manager/v1/scheduler/jobs/cron";
	...
	@MockBean
	private CronJobDescriptorDecorator mockCronJobDescriptorDecorator;
	...
	public void setUp() throws Exception {
		...
		when(mockCronJobDescriptorDecorator.toSchedulingData(anyList(),
	...
	public void testScheduleCronJob() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders
				.patch(URL_API_MANAGER_V1_scheduler_JOBS_CRON)
	...
	@Test
	public void testScheduleCronJob_invalid_ContentType() throws Exception {
		when(mockBaseClientProcessor.processRequest(mockJobSchedulingData))
				.thenReturn(mockschedulerManagementOperationResult);
		mockMvc.perform(MockMvcRequestBuilders
				.patch(URL_API_MANAGER_V1_scheduler_JOBS_CRON)
